<?php $__env->startSection('title', 'Blog & Tips Otomotif — Kerinci Motor'); ?>
<?php $__env->startSection('description', 'Artikel, panduan, dan tips seputar jual beli mobil bekas dari Kerinci Motor.'); ?>
...
<section class="py-16 px-4 bg-brand-black">
    <div class="max-w-7xl mx-auto">
        ...
        <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="blog-card block mb-12 group">
        ...
        <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="blog-card block bg-brand-dark-gray rounded-2xl overflow-hidden border border-white/5 group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\= vscode\Kerinci Motor\resources\views\blog\index.blade.php ENDPATH**/ ?>
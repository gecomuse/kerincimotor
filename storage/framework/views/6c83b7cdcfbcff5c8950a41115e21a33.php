...
<div class="car-card flex flex-col">
    ...
    <a href="<?php echo e(route('catalog.show', $car->slug)); ?>" class="block relative overflow-hidden aspect-video bg-brand-mid-gray">
        <img src="<?php echo e($thumb ?: $fallback); ?>"
    ...
    <div class="p-5 flex flex-col flex-1">
        <div class="flex items-start justify-between gap-2 mb-2">
            <a href="<?php echo e(route('catalog.show', $car->slug)); ?>">
        ...
        <div class="flex flex-wrap gap-2 mb-4">
            <span class="filter-chip text-xs"><?php echo e($car->year); ?></span>
            <span class="filter-chip text-xs"><?php echo e(ucfirst($car->transmission)); ?></span>
            <span class="filter-chip text-xs"><?php echo e($car->formatted_mileage); ?></span>
            <span class="filter-chip text-xs"><?php echo e(ucfirst(str_replace('_', ' ', $car->body_type))); ?></span>
        </div>
        ...
        <div class="mt-auto">
            ...
            <a href="<?php echo e($waUrl); ?>"
               ...
               onclick="trackWA('catalog', '<?php echo e(addslashes($car->make_model)); ?>', <?php echo e($car->price); ?>)"
...
<?php /**PATH D:\= vscode\Kerinci Motor\resources\views\components\car-card.blade.php ENDPATH**/ ?>
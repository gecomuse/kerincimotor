<div class="bg-brand-dark-gray border border-white/5 rounded-2xl p-6 md:p-10">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                <label class="km-label">Merek & Model <span class="text-brand-red">*</span></label>
                <input type="text" wire:model="car_make"
                       placeholder="contoh: Toyota Avanza"
                       class="km-input <?php $__errorArgs = ['car_make'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-brand-red/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="number" wire:model="car_year"
                       placeholder="<?php echo e(date('Y')); ?>" min="1990" max="<?php echo e(date('Y') + 1); ?>"
                       class="km-input <?php $__errorArgs = ['car_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-brand-red/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['car_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-brand-red text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="text" wire:model="car_mileage"
                       placeholder="contoh: 45000"
                       class="km-input <?php $__errorArgs = ['car_mileage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-brand-red/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['car_mileage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-brand-red text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                <label class="km-label">Kondisi Umum <span class="text-brand-red">*</span></label>
                <select wire:model="car_condition"
                        class="km-select <?php $__errorArgs = ['car_condition'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-brand-red/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['car_condition'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-brand-red text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex justify-between mt-8">
            <button type="button" wire:click="prevStep" class="btn-outline">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <?php elseif($step === 3): ?>
    <div>
        <h3 class="font-heading font-bold text-xl text-brand-white mb-6">Langkah 3 — Detail Penawaran</h3>
        ...
        <div class="bg-brand-mid-gray rounded-xl p-5 mb-6 text-sm">
            ...
            <div class="grid grid-cols-2 gap-y-2 gap-x-4">
                <div class="text-brand-text-gray">Nama</div>
                <div class="text-brand-white"><?php echo e($name); ?></div>
                <div class="text-brand-text-gray">WhatsApp</div>
                <div class="text-brand-white"><?php echo e($phone); ?></div>
                <div class="text-brand-text-gray">Kendaraan</div>
                <div class="text-brand-white"><?php echo e($car_make); ?></div>
                <div class="text-brand-text-gray">Tahun</div>
                <div class="text-brand-white"><?php echo e($car_year); ?></div>
                <div class="text-brand-text-gray">Kilometer</div>
                <div class="text-brand-white"><?php echo e($car_mileage); ?> KM</div>
                <div class="text-brand-text-gray">Kondisi</div>
                <div class="text-brand-white"><?php echo e($car_condition); ?></div>
            </div>
        </div>
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" wire:model="expected_price"
                       placeholder="contoh: 150.000.000"
                       class="km-input <?php $__errorArgs = ['expected_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-brand-red/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['expected_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-brand-red text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex justify-between mt-8">
            ...
            <button type="button" wire:click="submit" wire:loading.attr="disabled" class="btn-wa">
                ...
                <span wire:loading.remove wire:target="submit">Kirim via WhatsApp</span>
            </button>
        </div>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

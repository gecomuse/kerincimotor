<?php $__env->startSection('title', $post->title . ' — Kerinci Motor'); ?>
...
<meta property="og:image" content="<?php echo e($post->thumbnail_url); ?>">
...
<script type="application/ld+json">
{
  ...
  "description": <?php echo e(json_encode($post->excerpt)); ?>,
  "url": "<?php echo e(route('blog.show', $post->slug)); ?>",
  <?php if($post->thumbnail): ?>
  "image": "<?php echo e($post->thumbnail_url); ?>",
  <?php endif; ?>
...
<div class="pt-28 pb-0 px-4 bg-brand-dark-gray">
    <div class="max-w-3xl mx-auto">
        <nav class="flex items-center gap-2 text-xs text-brand-text-gray mb-6">
            ...
            <span>/</span>
            <a href="<?php echo e(route('blog.index')); ?>" class="hover:text-brand-white transition-colors">Blog</a>
            <span>/</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\= vscode\Kerinci Motor\resources\views\blog\show.blade.php ENDPATH**/ ?>
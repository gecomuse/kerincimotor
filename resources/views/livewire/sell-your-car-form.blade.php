        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" wire:model="car_make"
                       ...
                       class="km-input @error('car_make') border-brand-red/60 @enderror">
            ...
            <div>
                ...
                <input type="number" wire:model="car_year"
                       ...
                       class="km-input @error('car_year') border-brand-red/60 @enderror">
                @error('car_year')<p class="text-brand-red text-xs mt-1">{{ $message }}</p>@enderror
            </div>
            <div>
                <label class="km-label">Kilometer (KM) <span class="text-brand-red">*</span></label>
                <input type="text" wire:model="car_mileage"
                       placeholder="contoh: 45000"
                       class="km-input @error('car_mileage') border-brand-red/60 @enderror">
                @error('car_mileage')<p class="text-brand-red text-xs mt-1">{{ $message }}</p>@enderror
            </div>
            <div>
                <label class="km-label">Kondisi Umum <span class="text-brand-red">*</span></label>
                <select wire:model="car_condition"
                        class="km-select @error('car_condition') border-brand-red/60 @enderror">
                ...
                @error('car_condition')<p class="text-brand-red text-xs mt-1">{{ $message }}</p>@enderror
            </div>
        </div>
    ...
    <div>
        ...
        <div class="bg-brand-mid-gray rounded-xl p-5 mb-6 text-sm">
            ...
            <div class="grid grid-cols-2 gap-y-2 gap-x-4">
                ...
                <div class="text-brand-white">{{ $name }}</div>
                <div class="text-brand-text-gray">WhatsApp</div>
                <div class="text-brand-white">{{ $phone }}</div>
                <div class="text-brand-text-gray">Kendaraan</div>
                <div class="text-brand-white">{{ $car_make }}</div>
                <div class="text-brand-text-gray">Tahun</div>
                <div class="text-brand-white">{{ $car_year }}</div>
                <div class="text-brand-text-gray">Kilometer</div>
                <div class="text-brand-white">{{ $car_mileage }} KM</div>
                <div class="text-brand-text-gray">Kondisi</div>
                <div class="text-brand-white">{{ $car_condition }}</div>
            </div>
        </div>
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" wire:model="expected_price"
                       ...
                       class="km-input @error('expected_price') border-brand-red/60 @enderror">
                @error('expected_price')<p class="text-brand-red text-xs mt-1">{{ $message }}</p>@enderror
            </div>
            <div>
